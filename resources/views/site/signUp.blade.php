...
<div class="md:h-screen bg-white relative flex flex-col space-y-10 justify-center items-center">
   <div class="md:border md:border-gray-200 bg-white md:shadow-xl shadow-none rounded p-8 w-96">
     <h1 class="text-3xl font-bold leading-normal">Work<strong class="text-red-600">all</strong></h1>
     ...
     <form class="space-y-5 mt-5" action="/login/signIn" method="POST">
       ...
       <div
         ...
         <input name="password" id="password" type="password"
           ...
           required />
         <label for="password"
           class="label absolute mb-0 -mt-2 pt-4 pl-3 leading-tighter text-gray-500 text-base mt-2 cursor-text">Confirmar
           senha</label>
       </div>
       <button
   ...
   <p>Já possui conta?<a class="text-blue-600 font-bold hover:underline hover:p-5 p-2 rounded-full"
       href="{{ url('login') }}">Fazer login</a>
   </p>
 </div>
