...
<header class="flex justify-between items-center py-4 px-6 border-b-4  border-blue-700"> 
  ...
  <div class="flex items-center">
    ...
    <div class="relative mx-4 lg:mx-0">
      ...
      <input class="form-input w-32 sm:w-64 rounded-md pl-10 pr-4 p-2 border-2 border-gray-400 focus:border-indigo-600 bg-transparent" type="text"
        placeholder="Search">
    </div>
  </div>
  ...
  <div class="flex items-center">
    ...
    <div x-data="{ dropdownOpen: false }" class="relative">
      ...
      <div x-show="dropdownOpen"
        ...
        style="display: none;">
        <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Samuel Caitano</a>
        <a href="#"
          class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Products</a>
        <a href="/login"
          class="block px-4 py-2 text-sm text-gray-700 hover:bg-red-600 hover:text-white">Sair</a>
      </div>
    </div>
  </div>
</header> 
